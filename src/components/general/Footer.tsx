                ...
                <div className="flex flex-wrap justify-between gap-6">
                    ...
                    <div className="flex flex-col items-center mx-auto">
                        ...
                        <div className="flex items-center justify-center mx-auto gap-6 md:mt-6 mt-3">
                            <Link to="/" className="text-[#F6F6F6] md:text-xl text-xs font-medium">
                                Facebook
                            </Link>
                            <Link to="/" className="text-[#F6F6F6] md:text-xl text-xs font-medium">
                                X
                ...
                <div className="mt-14.5">
                    ...
                    <div className="md:mt-8 mt-4 grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 justify-between gap-8">
                        ...
                        <div className="flex flex-col items-center md:items-start gap-3">
                            ...
                            <Link to="/" className="text-[#FEFEFE] md:text-base text-xs font-semibold">{t("create_account")}</Link>
                            <Link to="/" className="text-[#FEFEFE] md:text-base text-xs font-semibold">{t("my_orders")}</Link>
                            <Link to="/faq" className="text-[#FEFEFE] md:text-base text-xs font-semibold">{t("faqs")}</Link>
                            <Link to="/contact_us" className="text-[#FEFEFE] md:text-base text-xs font-semibold">{t("contact_us")}</Link>
                        </div>
                        ...
                        <div className="flex flex-col items-center md:items-start gap-3">
                            ...
                            <a href="" className="flex items-center gap-2">
                                <Clover />
                                <p className="text-[#F6F6F6] text-sm font-medium">{t("clover_bay_tower")}</p>
                            </a>
                        </div>

                        <div className="flex flex-col items-center md:items-start gap-3">
                            <h3 className="text-[#FEFEFE] md:text-2xl text-sm font-medium leading-[100%]">{t("legal")}</h3>
                            <Link to="/" className="text-[#FEFEFE] md:text-base text-xs font-semibold">{t("privacy_policy")}</Link>
                            <Link to="/" className="text-[#FEFEFE] md:text-base text-xs font-semibold">{t("terms_conditions")}</Link>
                        </div>
                    </div>
                </div>
